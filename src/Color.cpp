...
Color::Color(void (*r)(void), unsigned int mainWin, unsigned int height, void (*d) (unsigned char, int,int), void (*u) (unsigned char, int,int)) {
	...
	mat.specular = 0;
	mats[0] = mat;
	red = openTexture("RED.png");
	green = openTexture("GRE.png");
	blue = openTexture("BLU.png");
	specular = openTexture("SPE.png");
	shininess = openTexture("SHI.png");
	add = openTexture("add.png");
	leftArrow = openTexture("leftarrow.png");
	rightArrow = openTexture("rightarrow.png");
